 ...
 * Simplified TypeScript-compliant server for deployment
 */
...
app.post('/api/v1/rockets/estimate', (req: Request, res: Response) => {
  try {
...
app.post('/api/v1/rockets', (req: Request, res: Response) => {
  try {
...
app.post('/api/v1/rockets/:id/launch', (req: Request, res: Response) => {
  try {
...
app.get('/api/v1/rockets/popular', (req: Request, res: Response) => {
